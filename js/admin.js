...
/* tamanhos oferecidos por padrão no formulário (principalmente para anéis) */
const TAMANHOS_SUGERIDOS = ["Único", "12", "14", "16", "18", "20", "22", "24", "26"];
  ...
  $("#listaCategorias").innerHTML = st.categorias.length
    ? st.categorias
      ...
      <div class="item">
        ...
        .join("")
    : `<div class="vazio">Nenhuma categoria ainda. Crie a primeira (ex.: Colares, Brincos, Anéis).</div>`;
...
function abrirProduto(p = null) {
  ...
  $("#pEmbalagem").checked = !!p?.embalagem;
