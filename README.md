...
A senha do painel nesse modo é a que está em `DEMO_SENHA` (padrão: `bijoux123`).
...
do nome; a consulta usa `array-contains`. Resolve bem o caso real ("colar",
"dourado", "anel") sem depender de serviço externo de busca.
